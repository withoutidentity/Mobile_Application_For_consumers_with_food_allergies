...
import { getMyProfile, updateUserAllergies, addScanHistory, getScanHistory, updateMyProfile } from '../controllers/user.controller';
...
userRoutes.put('/me', updateMyProfile);
